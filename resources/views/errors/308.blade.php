...
<body class="bg-gray-900 flex flex-col items-center justify-center min-h-screen text-white text-center">
    <div class="w-60 border-4 border-white p-2">
        <img class="w-full" src="https://media3.giphy.com/media/XaAUgxOriqslHO69U2/giphy.gif" alt="308 Permanent Redirection">
    </div>
    <h1 class="text-6xl font-bold mt-4">308</h1>
    <h2 class="text-2xl font-semibold">Permanent Redirection</h2>
