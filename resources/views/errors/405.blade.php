...
<body class="bg-gray-900 flex flex-col items-center justify-center min-h-screen text-white text-center">
    <div class="w-60 border-4 border-white p-2">
        <img class="w-full" src="https://i.gifer.com/8KWv.gif" alt="405 Image">
    </div>
    <h1 class="text-6xl font-bold mt-4">405</h1>
    <h2 class="text-2xl font-semibold">Method Not Allowed</h2>
