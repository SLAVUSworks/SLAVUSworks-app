...
<body class="bg-gray-900 flex flex-col items-center justify-center min-h-screen text-white text-center">
    <div class="w-60 border-4 border-white p-2">
        <img class="w-full" src="https://i0.wp.com/www.live-evil.org/wp-content/uploads/2022/06/sleepy.gif" alt="503 Service Unavailable">
    </div>
    <h1 class="text-6xl font-bold mt-4">503</h1>
    <h2 class="text-2xl font-semibold">Service Unavailable</h2>
