...
<body class="bg-gray-900 flex flex-col items-center justify-center min-h-screen text-white text-center">
    <div class="w-60 border-4 border-white p-2">
        <img class="w-full" src="https://allanimemag.files.wordpress.com/2020/12/heavens-lost-property-packing-boxes-screenshot-1.png" alt="301 Moved Permanently">
    </div>
    <h1 class="text-6xl font-bold mt-4">301</h1>
    <h2 class="text-2xl font-semibold">Moved Permanently</h2>
