...
<body class="bg-gray-900 flex flex-col items-center justify-center min-h-screen text-white text-center">
    <div class="w-60 border-4 border-white p-2">
        <img class="w-full" src="https://c.tenor.com/ULY2-MRkG7IAAAAC/load-loading-gif.gif" alt="504 Gateway Timeout">
    </div>
    <h1 class="text-6xl font-bold mt-4">504</h1>
    <h2 class="text-2xl font-semibold">Gateway Timeout</h2>
