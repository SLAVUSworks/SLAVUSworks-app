...
<body class="bg-gray-900 flex flex-col items-center justify-center min-h-screen text-white text-center">
    <div class="w-60 border-4 border-white p-2">
        <img class="w-full" src="https://c.tenor.com/9Ql_VyYvMZkAAAAC/anime-sleeping.gif" alt="502 Bad Gateway">
    </div>
    <h1 class="text-6xl font-bold mt-4">502</h1>
    <h2 class="text-2xl font-semibold">Bad Gateway</h2>
