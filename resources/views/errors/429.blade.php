...
<body class="bg-gray-900 flex flex-col items-center justify-center min-h-screen text-white text-center">
    <div class="w-60 border-4 border-white p-2">
        <img class="w-full" src="https://i.kym-cdn.com/photos/images/original/001/291/790/051.gif" alt="429 Too Many Requests">
    </div>
    <h1 class="text-6xl font-bold mt-4">429</h1>
    <h2 class="text-2xl font-semibold">Too Many Requests</h2>
