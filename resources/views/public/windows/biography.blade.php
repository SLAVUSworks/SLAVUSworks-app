...
@section('window')
    ...
    @foreach ($windows as $i => $window)
        ...
        <div id="{{ $windowId }}"
            class="window w-full md:w-[800px] max-w-full mx-auto shadow-xl border border-gray-700 bg-gray-100 z-10
            ...
            <div class="window-body p-3 sm:p-4 md:p-6 bg-gray-200 text-sm">
                <div class="flex flex-col md:flex-row gap-3 sm:gap-4 md:gap-6">
                    ...
                    <div class="flex-1 order-1 md:order-2 min-w-0">
                        ...
                        <div class="text-black p-3 sm:p-4 border border-gray-500 shadow-inner flex flex-col font-sans text-sm text-justify
